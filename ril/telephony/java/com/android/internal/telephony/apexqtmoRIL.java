...
/**
 * Qualcomm RIL for the Samsung apexqtmo.
 * stripped down version of SamsungQualcommRIL.java
 * {@hide}
 */
public class apexqtmoRIL extends RIL implements CommandsInterface {

    private Message mPendingGetSimStatus;

    public apexqtmoRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }
    public apexqtmoRIL(Context context, int networkMode,
